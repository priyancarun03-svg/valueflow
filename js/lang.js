...
function applyLang(lang) {
  ...
  // Footer copy — preserve green span
  ...
  // ── FIX: button shows the language to switch TO ──
  // Page is English  → show Swedish flag  (click = go Swedish)
  // Page is Swedish  → show English flag  (click = go English)
